    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/redbear/redbearbleclient/StandardViewFragmentForPinsEx$2

/* anonymous class */
    class StandardViewFragmentForPinsEx._cls2
        implements IRedBearServiceEventListener
    {
        ...
        public void onDeviceConnectStateChange(final String deviceAddress, final int state)
        {
            if (getActivity() != null)
            {
                getActivity().runOnUiThread(new StandardViewFragmentForPinsEx._cls2._cls2());
            }
        }
        ...
        {
            getActivity().runOnUiThread(i. new StandardViewFragmentForPinsEx._cls2._cls1());
        }
        ...
        // Unreferenced inner class com/redbear/redbearbleclient/StandardViewFragmentForPinsEx$2$2

/* anonymous class */
        class StandardViewFragmentForPinsEx._cls2._cls2
            implements Runnable
        {
