    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/redbear/redbearbleclient/StandardViewFragmentForPins$1

/* anonymous class */
    class StandardViewFragmentForPins._cls1
        implements ServiceConnection
    {
        ...
        public void onServiceConnected(ComponentName componentname, IBinder ibinder)
        {
            ...
            if (mRedBearService != null && mDevice != null)
            {
                ...
                textName.post(new StandardViewFragmentForPins._cls1._cls1());
            }
        }
